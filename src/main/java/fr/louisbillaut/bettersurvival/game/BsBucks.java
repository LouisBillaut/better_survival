...
public class BsBucks {
    ...
    private List<BSItem> itemsToSale = new ArrayList<>(List.of(
            ...
            new BSItem(new ItemStack(Material.SHULKER_BOX), 2005),
            ...
            new BSItem(new ItemStack(Material.TOTEM_OF_UNDYING), 1200),
            ...
            new BSItem(new ItemStack(Material.NAUTILUS_SHELL), 200),
